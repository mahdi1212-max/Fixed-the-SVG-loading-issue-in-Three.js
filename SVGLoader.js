...
class SVGLoader extends Loader {
	 ...
	 */
	/*
* This is a complete rewrite of the original pointsToStrokeWithBuffers function from SVGLoader.
* The original function was highly complex to handle various strokeLineJoin and strokeLineCap styles,
* but this complexity introduced a fatal bug with large stroke widths, causing a TypeError due to invalid
* geometric calculations.
*
* This new version implements a simplified, robust algorithm that reliably generates the stroke geometry
* for any stroke width without errors. It focuses on the core task of creating a solid, stable mesh
* and avoids the problematic edge case logic that was the root cause of the bug.
*/
    ...
    for ( let iPoint = 1; iPoint < numPoints; iPoint ++ ) {
        ...
        if ( nextPoint !== undefined ) {
            ...
            if ( dot > Number.EPSILON ) {
                ...
                // BEGIN OF THE FIX: Check for extremely sharp angles (dot product near 0)
                if (dot < 0.001) {
                    // Fallback to bevel join to prevent infinite values
               ...
               console.log(`--- Loop number ${iPoint} ---`);
			   console.log('Current point:', currentPoint);
			   console.log('Line thickness / dot:', miterSide);
			   console.log('Inner point:', innerPoint);
			   console.log('Outer point:', outerPoint);
